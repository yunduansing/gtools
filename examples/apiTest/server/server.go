...
func main() {
	config.InitConfig()
	middleware.Init()
	metrics.InitMetricsProvider("192.168.2.46:4318", config.Config.ServiceName, config.Uptrace.Version, "uptrace-dsn=http://project2_secret_token@192.168.2.46:14317/1")
